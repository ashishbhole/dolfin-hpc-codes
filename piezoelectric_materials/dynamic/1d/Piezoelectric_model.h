...
#ifndef __PIEZOELECTRIC_MODEL_H
#define __PIEZOELECTRIC_MODEL_H
#include <algorithm>
#include <cmath>
#include <iostream>
#include <stdexcept>
...
class piezoelectric_model_finite_element_0: public ufc::finite_element
{
public:

  piezoelectric_model_finite_element_0() : ufc::finite_element()
  {
    // Do nothing
  }

  ~piezoelectric_model_finite_element_0() override
  {
    // Do nothing
  }
  ...
  {
    return new piezoelectric_model_finite_element_0();
  }

};


class piezoelectric_model_finite_element_1: public ufc::finite_element
{
public:

  piezoelectric_model_finite_element_1() : ufc::finite_element()
  {
    // Do nothing
  }

  ~piezoelectric_model_finite_element_1() override
  {
    // Do nothing
  }
  ...
  ufc::finite_element * create() const final override
  {
    return new piezoelectric_model_finite_element_1();
  }

};


class piezoelectric_model_finite_element_2: public ufc::finite_element
{
public:

  piezoelectric_model_finite_element_2() : ufc::finite_element()
  {
    // Do nothing
  }

  ~piezoelectric_model_finite_element_2() override
  {
    // Do nothing
  }
  ...
  const char * signature() const final override
  {
    return "MixedElement(FiniteElement('Lagrange', interval, 1), FiniteElement('Lagrange', interval, 1))";
  }
  ...
  ufc::finite_element * create() const final override
  {
    return new piezoelectric_model_finite_element_2();
  }

};


class piezoelectric_model_finite_element_3: public ufc::finite_element
{
public:

  piezoelectric_model_finite_element_3() : ufc::finite_element()
  {
    // Do nothing
  }

  ~piezoelectric_model_finite_element_3() override
  {
    // Do nothing
  }
  ...
  ufc::finite_element * create() const final override
  {
    return new piezoelectric_model_finite_element_3();
  }

};


class piezoelectric_model_dofmap_0: public ufc::dofmap
{
public:

  piezoelectric_model_dofmap_0() : ufc::dofmap()
  {
    // Do nothing
  }

  ~piezoelectric_model_dofmap_0() override
  {
    // Do nothing
  }
  ...
  {
    return new piezoelectric_model_dofmap_0();
  }

};


class piezoelectric_model_dofmap_1: public ufc::dofmap
{
public:

  piezoelectric_model_dofmap_1() : ufc::dofmap()
  {
    // Do nothing
  }

  ~piezoelectric_model_dofmap_1() override
  {
    // Do nothing
  }
  ...
  ufc::dofmap * create() const final override
  {
    return new piezoelectric_model_dofmap_1();
  }

};


class piezoelectric_model_dofmap_2: public ufc::dofmap
{
public:

  piezoelectric_model_dofmap_2() : ufc::dofmap()
  {
    // Do nothing
  }

  ~piezoelectric_model_dofmap_2() override
  {
    // Do nothing
  }
  ...
  const char * signature() const final override
  {
    return "FFC dofmap for MixedElement(FiniteElement('Lagrange', interval, 1), FiniteElement('Lagrange', interval, 1))";
  }
  ...
  ufc::dofmap * create() const final override
  {
    return new piezoelectric_model_dofmap_2();
  }

};


class piezoelectric_model_dofmap_3: public ufc::dofmap
{
public:

  piezoelectric_model_dofmap_3() : ufc::dofmap()
  {
    // Do nothing
  }

  ~piezoelectric_model_dofmap_3() override
  {
    // Do nothing
  }
  ...
  ufc::dofmap * create() const final override
  {
    return new piezoelectric_model_dofmap_3();
  }

};


class piezoelectric_model_coordinate_mapping_1: public ufc::coordinate_mapping
{
public:

  piezoelectric_model_coordinate_mapping_1() : ufc::coordinate_mapping()
  {
    // Do nothing
  }

  ~piezoelectric_model_coordinate_mapping_1() override
  {
    // Do nothing
  }
  ...
  {
    return new piezoelectric_model_coordinate_mapping_1();
  }
  ...
  {
    piezoelectric_model_finite_element_0 xelement;
    double phi[2];
    for (std::size_t ip = 0; ip < num_points; ++ip)
    {
...
class piezoelectric_model_cell_integral_0_otherwise: public ufc::cell_integral
{
public:

  piezoelectric_model_cell_integral_0_otherwise() : ufc::cell_integral()
  {

  }

  ~piezoelectric_model_cell_integral_0_otherwise() override
  {
...
return enabled;
                       ...
                       int cell_orientation) const final override
  {
    ...
    sp[0] = (1 + -1 * w[2][0]) * (1.0 / J_c0);
    sp[1] = 23.3 * sp[0] * (1.0 / J_c0);
    sp[2] = 0.5 + w[2][0] + -1 * w[1][0];
    sp[3] = 1.0 / (std::pow(0.5 + sp[2], 2) / 4.0) / std::pow(w[0][0], 2);
    sp[4] = (1 + -1 * w[1][0]) * sp[3];
    sp[5] = 1.3e-8 * (1.0 / J_c0) * (1.0 / J_c0);
    sp[6] = 23.3 * (1.0 / J_c0) * (1.0 / J_c0);
    sp[7] = 117000000000.0 * sp[0] * (1.0 / J_c0);
    sp[8] = std::abs(J_c0);
    sp[9] = -1 * sp[1] * sp[8];
    sp[10] = sp[7] * sp[8];
    sp[11] = sp[5] * sp[8];
    sp[12] = 7500.0 * sp[4] * sp[8];
    sp[13] = sp[6] * sp[8];
    A[0] = 0.3333333333333334 * sp[12] + sp[10];
    A[1] = 0.1666666666666667 * sp[12] - sp[10];
    A[2] = sp[13];
    A[3] = -sp[13];
    A[4] = 0.1666666666666667 * sp[12] - sp[10];
    A[5] = 0.3333333333333334 * sp[12] + sp[10];
    A[6] = -sp[13];
    A[7] = sp[13];
    A[8] = sp[9];
    A[9] = -sp[9];
...
class piezoelectric_model_cell_integral_1_otherwise: public ufc::cell_integral
{
public:

  piezoelectric_model_cell_integral_1_otherwise() : ufc::cell_integral()
  {

  }

  ~piezoelectric_model_cell_integral_1_otherwise() override
  {
  ...
  const std::vector<bool> & enabled_coefficients() const final override
  {
static const std::vector<bool> enabled({false, true, true, true, true, true, true});
return enabled;
  }
                       ...
                       int cell_orientation) const final override
  {
    ...
    for (int ic = 0; ic < 2; ++ic)
        w1_d0 += w[1][ic] * FE0_C0_D1_Q2[0][0][ic];
    const double J_c0 = coordinate_dofs[0] * FE0_C0_D1_Q2[0][0][0] + coordinate_dofs[1] * FE0_C0_D1_Q2[0][0][1];
    alignas(32) double sp[9];
    sp[0] = 0.5 + w[6][0] + -1 * w[5][0];
    sp[1] = (1 + -1 * (2 * (std::pow(0.5 + sp[0], 2) / 4.0))) / 2 / (std::pow(0.5 + sp[0], 2) / 4.0);
    sp[2] = w1_d0 * (1.0 / J_c0);
    sp[3] = sp[2] * w[6][0];
    sp[4] = 23.3 * sp[3] * (1.0 / J_c0);
    sp[5] = 117000000000.0 * sp[3] * (1.0 / J_c0);
    sp[6] = std::abs(J_c0);
    sp[7] = -1 * (-1 * sp[4]) * sp[6];
    sp[8] = -1 * sp[5] * sp[6];
    ...
    for (int iq = 0; iq < 2; ++iq)
    {
        ...
        double w3 = 0.0;
        for (int ic = 0; ic < 2; ++ic)
            w3 += w[3][ic] * FE0_C0_Q2[0][iq][ic];
        double w2 = 0.0;
        for (int ic = 0; ic < 2; ++ic)
            w2 += w[2][ic] * FE0_C0_Q2[0][iq][ic];
        double w1 = 0.0;
        for (int ic = 0; ic < 2; ++ic)
            w1 += w[1][ic] * FE0_C0_Q2[0][iq][ic];
        alignas(32) double sv2[10];
        sv2[0] = sp[1] * w3;
        sv2[1] = w2 * w[4][0];
        sv2[2] = -1 * sv2[1] + -1 * w1;
        sv2[3] = sv2[2] / (std::pow(0.5 + sp[0], 2) / 4.0);
        sv2[4] = sv2[3] / std::pow(w[4][0], 2);
        sv2[5] = -1 * sv2[0] + sv2[4];
        sv2[6] = (1 + -1 * w[5][0]) * sv2[5];
        sv2[7] = w3 * w[5][0];
        sv2[8] = sv2[6] + sv2[7];
        sv2[9] = -1 * (7500.0 * sv2[8]) * sp[6];
...
class piezoelectric_model_exterior_facet_integral_1_2: public ufc::exterior_facet_integral
{
public:

  piezoelectric_model_exterior_facet_integral_1_2() : ufc::exterior_facet_integral()
  {

  }

  ~piezoelectric_model_exterior_facet_integral_1_2() override
  {
...
return enabled;
                       ...
                       int cell_orientation) const final override
  {
    ...
    // PI* dimensions: [entities][dofs][dofs] or [entities][dofs]
    // PM* dimensions: [entities][dofs][dofs]
    alignas(32) static const double FE0_C0_F_Q1[2][1][2] =
        { { { 1.0, 0.0 } },
          { { 0.0, 1.0 } } };
    ...
    double w0 = 0.0;
    for (int ic = 0; ic < 2; ++ic)
        w0 += w[0][ic] * FE0_C0_F_Q1[facet][0][ic];
    A[0] = -1 * (-1 * w0) * PI0[facet][0];
    A[1] = -1 * (-1 * w0) * PI0[facet][1];
    std::fill(A + 2, A + 4, 0.0);
  }

};


class piezoelectric_model_form_0: public ufc::form
{
public:

  piezoelectric_model_form_0() : ufc::form()
  {
    // Do nothing
  }

  ~piezoelectric_model_form_0() override
  {
    // Do nothing
  }
  ...
  const char * signature() const final override
  {
    return "3f1a83626973b0667aa9a103846e07ff9958b1026cb0739f6b1c9809fe5a2219ce906f0a82ad6d78b1f2f40f4203fcfbd89fccfd8d44bebcceb3b9d12c6866aa";
  }
  ...
  {
    return new piezoelectric_model_cell_integral_0_otherwise();
  }
...
class piezoelectric_model_form_1: public ufc::form
{
public:

  piezoelectric_model_form_1() : ufc::form()
  {
    // Do nothing
  }

  ~piezoelectric_model_form_1() override
  {
    // Do nothing
  }
  ...
  const char * signature() const final override
  {
    return "10808ff2c298373223a4fcb2a463f1ad1495b0a140f64ba41e6716cc1e8d033b2f3b2ffd6724b71df09169df86c2795bf5708c34643c95c25e4428fcba96f82a";
  }
  ...
  ufc::exterior_facet_integral * create_exterior_facet_integral(std::size_t subdomain_id) const final override
  {
    ...
    {
    case 2:
        return new piezoelectric_model_exterior_facet_integral_1_2();
    default:
        return nullptr;
    }
  }
  ...
  ufc::cell_integral * create_default_cell_integral() const final override
  {
    return new piezoelectric_model_cell_integral_1_otherwise();
  }
...
private:
  ...
  // UFC form
  piezoelectric_model_form_0 form_;
...
private:
  ...
  // UFC form
  piezoelectric_model_form_1 form_;
