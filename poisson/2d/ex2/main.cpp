...
// Poissons equation with Dirichlet and Neumann bcs
// From https://fenicsproject.org/olddocs/dolfin/1.5.0/python/demo/documented/poisson/python/documentation.html
...
struct NeumannFunction : public Value< NeumannFunction >
{
  void eval( real * value, const real * x ) const
  {
    value[0] = sin(5.0*x[0]);
