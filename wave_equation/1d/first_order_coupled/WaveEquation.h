...
return enabled;
                       ...
                       int cell_orientation) const final override
  {
    ...
    sp[4] = sp[1] * sp[2];
    sp[5] = -1 * sp[1] * sp[2];
    A[0] = 0.3333333333333334 * sp[2] + -0.5 * sp[4];
    A[1] = 0.1666666666666667 * sp[2] + 0.5 * sp[4];
    A[2] = 0.3333333333333334 * sp[3];
    A[3] = 0.1666666666666667 * sp[3];
    A[4] = 0.1666666666666667 * sp[2] + -0.5 * sp[4];
    A[5] = 0.3333333333333334 * sp[2] + 0.5 * sp[4];
    A[6] = 0.1666666666666667 * sp[3];
    A[7] = 0.3333333333333334 * sp[3];
    std::fill(A + 8, A + 10, 0.0);
    A[10] = 0.3333333333333334 * sp[2] + -0.5 * sp[5];
    A[11] = 0.1666666666666667 * sp[2] + 0.5 * sp[5];
    std::fill(A + 12, A + 14, 0.0);
    A[14] = 0.1666666666666667 * sp[2] + -0.5 * sp[5];
    A[15] = 0.3333333333333334 * sp[2] + 0.5 * sp[5];
  }
...
public:
  ...
  const char * signature() const final override
  {
    return "a0004ab4b077ef0585cb566376a68046949928f7a9c478054c176c089da771fae7e7aa74d550e69665450037e555058eacadbfc63a6d8b9f41f88e75f0f03b6b";
  }
...
public:
  ...
  const char * signature() const final override
  {
    return "827cad3d2fc55078b30449435c1d6d9d10edf5ff373b8e1e80cb9b0b53e18a57a0c7771725748a25d3bcdfea4327757d19cc005e8e2655e64dac9bf5fcc5f7c7";
  }
