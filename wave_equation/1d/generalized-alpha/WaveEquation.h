...
return enabled;
                       ...
                       int cell_orientation) const final override
  {
    ...
    sp[0] = (1 + -1 * w[3][0]) * (1.0 / J_c0);
    sp[1] = w[0][0] * w[0][0];
    sp[2] = sp[0] * sp[1];
    sp[3] = sp[2] * (1.0 / J_c0);
    sp[4] = 0.5 + w[3][0] + -1 * w[2][0];
    sp[5] = 1.0 / (std::pow(0.5 + sp[4], 2) / 4.0) / std::pow(w[1][0], 2);
    sp[6] = (1 + -1 * w[2][0]) * sp[5];
    sp[7] = std::abs(J_c0);
    sp[8] = sp[3] * sp[7];
    sp[9] = sp[6] * sp[7];
    A[0] = 0.3333333333333334 * sp[9] + sp[8];
    A[1] = 0.1666666666666667 * sp[9] - sp[8];
    A[2] = 0.1666666666666667 * sp[9] - sp[8];
    A[3] = 0.3333333333333334 * sp[9] + sp[8];
  }
...
return enabled;
                       ...
                       int cell_orientation) const final override
  {
    ...
    for (int iq = 0; iq < 2; ++iq)
    {
        ...
        sv2[4] = sv2[3] / std::pow(w[5][0], 2);
        sv2[5] = -1 * sv2[0] + sv2[4];
        sv2[6] = (1 + -1 * w[6][0]) * sv2[5];
        sv2[7] = w2 * w[6][0];
        sv2[8] = sv2[6] + sv2[7];
        sv2[9] = -1 * sv2[8] + -1 * (-1 * w3);
        sv2[10] = sv2[9] * sp[7];
...
public:
  ...
  const char * signature() const final override
  {
    return "71d011172650350a5f319b31d7efbb71fd728958f31f2833f0e08471e46eeb3a8135e3a051d02ed2b9ffe1f3ddbb0687b9d90d32cbe888256722ab2a0ce3e37c";
  }
...
public:
  ...
  const char * signature() const final override
  {
    return "6abaa64e5a0e3bcc6cb5aa48163701bc22bb08a364c4a96d890f5b333ae0ef0d6990cb0b9c6a18bccc4a2eb308829015f6d98ec55f256aebb8fa6787acb8c2d0";
  }
