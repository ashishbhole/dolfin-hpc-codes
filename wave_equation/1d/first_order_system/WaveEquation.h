...
return enabled;
                       ...
                       int cell_orientation) const final override
  {
    ...
    sp[3] = sp[0] * w[0][0];
    sp[4] = std::abs(J_c0);
    sp[5] = (1.0 + -1 * w[0][0]) * sp[4];
    sp[6] = sp[2] * sp[4];
    sp[7] = sp[3] * sp[4];
    A[0] = 0.3333333333333334 * sp[5] + -0.5 * sp[6];
    A[1] = 0.1666666666666667 * sp[5] + 0.5 * sp[6];
    std::fill(A + 2, A + 4, 0.0);
    A[4] = 0.1666666666666667 * sp[5] + -0.5 * sp[6];
    A[5] = 0.3333333333333334 * sp[5] + 0.5 * sp[6];
    std::fill(A + 6, A + 10, 0.0);
    A[10] = 0.3333333333333334 * sp[5] + -0.5 * sp[7];
    A[11] = 0.1666666666666667 * sp[5] + 0.5 * sp[7];
    std::fill(A + 12, A + 14, 0.0);
    A[14] = 0.1666666666666667 * sp[5] + -0.5 * sp[7];
    A[15] = 0.3333333333333334 * sp[5] + 0.5 * sp[7];
  }
...
public:
  ...
  const char * signature() const final override
  {
    return "184282510b0af5755f7eb9315bd0c2394af13a4257c74781ced02168d32fc1e9f6ece2ca0eafebb7b64923741c1770ad14624079bd85dc4fa8e3aa8340665bc7";
  }
