...
class projection_coordinate_mapping_2: public ufc::coordinate_mapping
{
public:

  projection_coordinate_mapping_2() : ufc::coordinate_mapping()
  {
    // Do nothing
  }

  ~projection_coordinate_mapping_2() override
  {
    // Do nothing
  }
  ...
  {
    return new projection_coordinate_mapping_2();
  }
...
return enabled;
                       ...
                       int cell_orientation) const final override
  {
    ...
    sp[0] = std::abs(J_c0);
    A[0] = 0.3333333333333334 * sp[0];
    A[1] = 0.1666666666666667 * sp[0];
    std::fill(A + 2, A + 4, 0.0);
    A[4] = 0.1666666666666667 * sp[0];
    A[5] = 0.3333333333333334 * sp[0];
    std::fill(A + 6, A + 10, 0.0);
    A[10] = 0.3333333333333334 * sp[0];
    A[11] = 0.1666666666666667 * sp[0];
    std::fill(A + 12, A + 14, 0.0);
    A[14] = 0.1666666666666667 * sp[0];
    A[15] = 0.3333333333333334 * sp[0];
  }
...
public:
  ...
  const char * signature() const final override
  {
    return "3c7ca51c846310b569a293d61bff4cb714e7bf3f91c59a094bdf979c5418a59a992b9b39bc80e3d75016a9163577db1f1ff530bfbbbc233332f230910a7d80b2";
  }
...
public:
  ...
  const char * signature() const final override
  {
    return "83d3c765939d029ae762683fbf27f87ed67e99ed54951305d9fc9c57a51e41e2a09f05b4f0fc4e6753990aa2aeb1fd1ed7865753f144f7ad0c5d8a9a2f5dfcea";
  }
